...
author1 = Author.create(name: "James Jackson", biography: Faker::Lorem.paragraph)
author2 = Author.create(name: "Roberta Rock", biography: Faker::Lorem.paragraph)
author3 = Author.create(name: "Daniel Duck", biography: Faker::Lorem.paragraph)
author4 = Author.create(name: "Amanda Djidjinski", biography: Faker::Lorem.paragraph)
author5 = Author.create(name: "Zoe Zack", biography: Faker::Lorem.paragraph)
author6 = Author.create(name: "Bill Burray", biography: Faker::Lorem.paragraph)
author7 = Author.create(name: "Charlie Chuck", biography: Faker::Lorem.paragraph)
